!(function (t, e) {
  ...
  function F(t, e) {
    for (
      ...
      n && (n === jt.ghost || "none" === R(n, "display") || (e && !p(n, e)));
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              var v = B(a, 0, s, !0);
              if (v === Z) return A(!1);
              if (((E = X((l = v))), !1 !== Ht(J, a, Z, o, l, E, n, !1)))
              ...
              if (
                (vt !== l &&
                  ((y = E[_]), (_t = !1), (Ct = (!S && s.invertSwap) || D)),
                0 !==
              ...
              if (!1 !== S)
                return (
                  ...
                  D && !x
                    ? a.appendChild(Z)
                    : l.parentNode.insertBefore(Z, D ? x : l),
  ...
  methods: {
    ...
    toggleSortable(enable) {
      if (this.sortableInstance) {
        this.sortableInstance.option("disabled", !enable);
      }
    },
  },
};
